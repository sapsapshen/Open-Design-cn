...
Open Design - Chinese Optimized Version discovers them, and what to do if you do not have Codex
installed.
...
You do not need Codex to use Open Design - Chinese Optimized Version. The pet companion ships with
