# NotebookLM: export issues/PRs from Open Design - Chinese Optimized Version

Open Design - Chinese Optimized Version gets a lot of feedback via GitHub Issues + PRs. If you want NotebookLM to help with:
