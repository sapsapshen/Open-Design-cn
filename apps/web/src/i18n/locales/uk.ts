...
export const uk: Dict = {
  ...
  'settings.welcomeTitle': 'Налаштування Open Design - Chinese Optimized Version',
  ...
  'settings.agentInstall.pathHint':
    'Якщо ви встановили CLI через npm або Homebrew, але вона все ще відображається як не встановлена, переконайтеся, що bin-каталог інструмента є у PATH, який успадковує daemon Open Design - Chinese Optimized Version (у macOS PATH у Terminal і GUI-застосунків може відрізнятися). Див. QUICKSTART.md (розділ "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Відкрийте Встановити або Документація для потрібного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдіть автентифікацію у CLI постачальника (увійдіть або додайте API-облікові дані), потім поверніться до Open Design - Chinese Optimized Version.',
  ...
  'settings.mcpServerHint': 'Відкрийте Open Design - Chinese Optimized Version як MCP-сервер для вашого кодинг-агента.',
  ...
  'preview.errorBody': 'Не вдалося отримати HTML прикладу. Переконайтеся, що Open Design - Chinese Optimized Version запущено, і повторіть спробу.',
  ...
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з Open Design - Chinese Optimized Version — виберіть один та встановіть.',
  ...
  'pet.codexBundledTitle': 'Поставляється з Open Design - Chinese Optimized Version — завантаження не потрібне.',
