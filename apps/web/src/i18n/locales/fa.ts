...
export const fa: Dict = {
  ...
  'settings.welcomeTitle': 'Open Design - Chinese Optimized Version را راه‌اندازی کنید',
  ...
  'settings.agentInstall.stepAuth':
    'قبل از بازگشت به Open Design - Chinese Optimized Version، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'Open Design - Chinese Optimized Version را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید Open Design - Chinese Optimized Version در حال اجراست و دوباره تلاش کنید.',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه Open Design - Chinese Optimized Version — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه Open Design - Chinese Optimized Version ارائه می‌شود — نیازی به دانلود نیست.',
