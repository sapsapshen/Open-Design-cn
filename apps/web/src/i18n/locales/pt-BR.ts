...
export const ptBR: Dict = {
  ...
  'settings.welcomeTitle': 'Configure o Open Design - Chinese Optimized Version',
  ...
  'settings.agentInstall.pathHint':
    'Se você instalou uma CLI com npm ou Homebrew e ela ainda aparece como não instalada, garanta que o diretório bin da ferramenta esteja no PATH herdado pelo daemon do Open Design - Chinese Optimized Version (Terminal e apps GUI podem diferir no macOS). Veja QUICKSTART.md (seção "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abra Instalar ou Docs para o agente desejado.',
  'settings.agentInstall.stepAuth':
    'Autentique-se na CLI do fornecedor (faça login ou adicione credenciais de API) antes de voltar ao Open Design - Chinese Optimized Version.',
  ...
  'settings.mcpServerHint': 'Exponha o Open Design - Chinese Optimized Version como servidor MCP para o seu agente de código.',
  ...
  'preview.errorBody': 'A obtenção do HTML do exemplo falhou. Verifique se o Open Design - Chinese Optimized Version está em execução e tente novamente.',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no Open Design - Chinese Optimized Version — escolha um e adote.',
  ...
  'pet.codexBundledTitle': 'Já vem com o Open Design - Chinese Optimized Version — sem download.',
