...
export const id: Dict = {
  ...
  'settings.welcomeTitle': 'Siapkan Open Design - Chinese Optimized Version',
  ...
  'settings.agentInstall.pathHint':
    'Jika Anda memasang CLI dengan npm atau Homebrew tetapi masih tampil sebagai belum terpasang, pastikan direktori bin alat ada di PATH yang diwarisi daemon Open Design - Chinese Optimized Version (PATH Terminal dan aplikasi GUI bisa berbeda di macOS). Lihat QUICKSTART.md (bagian "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Buka Instal atau Dokumentasi untuk agen pilihan Anda.',
  'settings.agentInstall.stepAuth':
    'Lakukan autentikasi di CLI vendor (masuk atau tambahkan kredensial API) sebelum kembali ke Open Design - Chinese Optimized Version.',
  ...
  'settings.mcpServerHint': 'Ekspos Open Design - Chinese Optimized Version sebagai server MCP untuk agen koding Anda.',
  ...
  'preview.errorBody': 'Pengambilan HTML contoh gagal. Pastikan Open Design - Chinese Optimized Version berjalan, lalu coba lagi.',
  ...
  'pet.tabBuiltInHint': 'Pet pilihan yang disertakan dengan Open Design - Chinese Optimized Version - pilih satu lalu adopsi.',
  ...
  'pet.codexBundledTitle': 'Disertakan dengan Open Design - Chinese Optimized Version - tidak perlu diunduh.',
