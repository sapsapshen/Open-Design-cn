...
export const hu: Dict = {
  ...
  'settings.welcomeTitle': 'Open Design - Chinese Optimized Version beállítása',
  ...
  'settings.agentInstall.pathHint':
    'Ha npm-mel vagy Homebrew-val telepítettél egy CLI-t, de továbbra is nincs telepítve állapotban látszik, ellenőrizd, hogy az eszköz bin könyvtára benne van-e abban a PATH-ban, amit az Open Design - Chinese Optimized Version daemon örököl (macOS-en a Terminal és a GUI appok PATH-ja eltérhet). Lásd a QUICKSTART.md "Local agent CLI and PATH" szakaszát.',
  'settings.agentInstall.stepOpenLinks': 'Nyisd meg a Telepítés vagy Dokumentáció hivatkozást a kívánt ügynöknél.',
  'settings.agentInstall.stepAuth':
    'Hitelesíts a szolgáltató CLI-jében (bejelentkezés vagy API hitelesítő adatok megadása), mielőtt visszatérsz az Open Design - Chinese Optimized Versionhoz.',
  ...
  'settings.mcpServerHint': 'Tedd elérhetővé az Open Design - Chinese Optimized Versiont MCP-szerverként a kódügynököd számára.',
  ...
  'preview.errorBody': 'A példa HTML-jének letöltése meghiúsult. Győződj meg róla, hogy az Open Design - Chinese Optimized Version fut, majd próbáld újra.',
  'preview.retry': 'Újra',
  ...
  'pet.tabBuiltInHint': 'Az Open Design - Chinese Optimized Versionnal csomagolt társak — válassz egyet és fogadd örökbe.',
  ...
  'pet.codexBundledTitle': 'Az Open Design - Chinese Optimized Versiongal érkezik — letöltés nem szükséges.',
