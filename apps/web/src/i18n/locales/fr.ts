...
export const fr: Dict = {
  ...
  'settings.welcomeTitle': 'Configurer Open Design - Chinese Optimized Version',
  ...
  'settings.agentInstall.pathHint':
    'Si vous avez installé une CLI avec npm ou Homebrew et qu\'elle apparaît toujours comme non installée, vérifiez que le dossier bin de l\'outil est dans le PATH hérité par le daemon Open Design - Chinese Optimized Version (Terminal et apps GUI peuvent différer sur macOS). Voir QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Ouvrez Installer ou Docs pour l\'agent souhaité.',
  'settings.agentInstall.stepAuth':
    'Authentifiez-vous avec la CLI du fournisseur (connexion ou ajout des identifiants API) avant de revenir dans Open Design - Chinese Optimized Version.',
  ...
  'settings.mcpServerHint': 'Exposez Open Design - Chinese Optimized Version comme serveur MCP pour votre agent de code.',
  ...
  'preview.errorBody': 'Le chargement du HTML de l\'exemple a échoué. Vérifiez qu\'Open Design - Chinese Optimized Version est en cours d\'exécution et réessayez.',
  ...
  'pet.tabBuiltInHint': 'Compagnons fournis avec Open Design - Chinese Optimized Version — choisissez-en un et adoptez-le.',
  ...
  'pet.codexBundledTitle': 'Livré avec Open Design - Chinese Optimized Version — aucun téléchargement nécessaire.',
