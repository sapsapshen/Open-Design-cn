...
<html lang="en">
  <head>
    ...
    <title>${connectorLabelHtml} connected · Open Design - Chinese Optimized Version</title>
    <style>
      :root {
        --bg: #faf9f7;
        --bg-panel: #ffffff;
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="Open Design - Chinese Optimized Version">
        <span class="brand-mark" aria-hidden="true">OD</span>
        <span class="brand-title">Open Design - Chinese Optimized Version</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in Open Design - Chinese Optimized Version.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to Open Design - Chinese Optimized Version.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to Open Design - Chinese Optimized Version.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to Open Design - Chinese Optimized Version.';
        }
