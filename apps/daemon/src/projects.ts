...
function buildDesignManifest(entries, projectLabel) {
  ...
  return JSON.stringify({
    ...
    title: projectLabel || 'Open Design - Chinese Optimized Version project',
    entryFile,
    sourceFiles: {
      all: files,
      html: htmlFiles,
...
function buildDesignHandoff(entries, projectLabel) {
  ...
  return `# ${projectLabel || 'Open Design - Chinese Optimized Version project'} implementation handoff
...
- Keep generated product UI free of Open Design - Chinese Optimized Version chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or Open Design - Chinese Optimized Version chrome in the production UI.
